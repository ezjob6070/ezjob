...
const CalendarWidget = ({ selectedDate, setSelectedDate, jobs }: CalendarWidgetProps) => {
      ...
      <Calendar
        ...
        components={{
          Day: ({ date, displayMonth, ...props }: DayProps) => {
            // Using the DayProps correctly without accessing the non-existent 'selected' property
