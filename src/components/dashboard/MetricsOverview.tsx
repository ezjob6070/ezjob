  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <DashboardMetricCard
        title="Jobs"
        value="68"
        icon={<BriefcaseIcon size={20} className="text-purple-500" />}
      ...
      <DashboardMetricCard
        ...
        icon={<CalculatorIcon size={20} className="text-green-500" />}
        description="Revenue this month"
        trend={{ value: "5%", isPositive: false }}
        className="bg-gradient-to-br from-green-50 to-teal-50 border-green-100"
        variant="gradient"
