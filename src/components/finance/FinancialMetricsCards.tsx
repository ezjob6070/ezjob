      ...
      <Card>
        <CardContent className="pt-6">
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">All completed transactions</p>
      ...
      <Card>
        <CardContent className="pt-6">
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">Net earnings after expenses</p>
      ...
      <Card>
        <CardContent className="pt-6">
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">Total costs and payments</p>
