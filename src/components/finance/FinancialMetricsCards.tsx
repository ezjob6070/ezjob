    ...
    <div className="grid gap-4 md:grid-cols-3">
      <Card>
        <CardContent className="pt-6">
          <div>
            <p className="text-base font-semibold text-gray-900">Total Income</p>
      ...
      <Card>
        <CardContent className="pt-6">
          <div>
            <p className="text-base font-semibold text-gray-900">Company Profit</p>
      ...
      <Card>
        <CardContent className="pt-6">
          <div>
            <p className="text-base font-semibold text-gray-900">Expenses</p>
