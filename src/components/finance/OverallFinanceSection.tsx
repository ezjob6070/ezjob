    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <DashboardMetricCard
          ...
          variant="finance"
          valueClassName="text-blue-600 text-2xl mt-1"
        >
          <p className="text-xs text-muted-foreground mt-1">Gross revenue from all services</p>
        </DashboardMetricCard>
        ...
        <DashboardMetricCard
          ...
          variant="finance"
          valueClassName="text-red-600 text-2xl mt-1"
        >
          <p className="text-xs text-muted-foreground mt-1">All costs and operational expenses</p>
        </DashboardMetricCard>
        ...
        <DashboardMetricCard
          ...
          variant="finance"
          valueClassName="text-emerald-600 text-2xl mt-1"
        >
          <p className="text-xs text-muted-foreground mt-1">Company earnings after all costs</p>
        </DashboardMetricCard>
      </div>
    </div>
  );
