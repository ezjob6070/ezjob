...
import { useTechnicianFinancials, TechnicianFinancialsHookReturn } from "@/hooks/technicians";
...
const TechniciansDashboard: React.FC<TechniciansDashboardProps> = ({
  ...
  }: TechnicianFinancialsHookReturn = useTechnicianFinancials(filteredTechnicians, dateRange);
