...
const DashboardMetrics: React.FC<DashboardMetricsProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      ...
      >
        <p className="text-sm text-muted-foreground -mt-3 mb-1">All revenue from completed jobs</p>
      </DashboardMetricCard>
      ...
      >
        <p className="text-sm text-muted-foreground -mt-3 mb-1">Total amounts paid to technicians</p>
      </DashboardMetricCard>
      ...
      >
        <p className="text-sm text-muted-foreground -mt-3 mb-1">Net profit after all expenses</p>
      </DashboardMetricCard>
    </div>
  );
};
