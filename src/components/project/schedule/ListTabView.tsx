...
import { getEventTypeIcon, getEventTypeBadgeColor, getEventStatusBadgeColor } from "./eventUtils";

interface ListTabViewProps {
  filteredEvents: ScheduleEvent[];
  setSelectedEvent: (event: ScheduleEvent) => void;
}

export default function ListTabView({ filteredEvents, setSelectedEvent }: ListTabViewProps) {
