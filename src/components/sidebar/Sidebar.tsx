...
const Sidebar = ({ isMobile }: SidebarProps) => {
  ...
  try {
    // Add a try-catch to help us debug issues with the GlobalStateProvider
    ...
    // If there's an error with GlobalStateProvider, render a minimal sidebar
    return (
      <aside className="fixed left-0 top-0 bottom-0 z-30">
        <div className="h-full bg-gradient-to-b from-blue-700 to-blue-900 shadow-lg w-16">
